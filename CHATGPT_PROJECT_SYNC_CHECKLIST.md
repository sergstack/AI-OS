...
read-back confirmed replacement under canonical filenames for all seven
registered project bundles; their changed bundle sources have no duplicate
same-name entries. This is transport evidence only and does not update
acceptance status or prove new behavioural smoke QA. `[Thinkers OS]` remains
`not_verified` for Project Instructions, smoke QA, and pilot execution.
