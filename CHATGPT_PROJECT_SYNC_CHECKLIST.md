...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `[AI OS]` | `ChatGPT/[AI OS]` | `ChatGPT/[AI OS]/PROJECT_INSTRUCTIONS.md` | not_verified | not_verified | `ChatGPT/[AI OS]/Knowledge/` | not_verified | not_verified | not_verified | not_verified | done | not_verified | draft | unsupported | Sergey | ChatGPT UI sync not evidenced | Manually paste instructions, upload expected Knowledge, run smoke QA, then run pilot `PILOT-AIOS-001` | none |
