...
- native_subagent_dispatch_status: bounded pilot under 2026-09-02 carve-out; hardened — mandatory worktree isolation (DEF-001 closed) + structural no-nesting (no write-capable child); 6 observed multi-owner executions; recommendation STANDARDIZE BOUNDED (conditional) on a 4-item punch-list, else KEEP PILOT-ONLY until it lands; not a standard workflow; evidence in docs/evidence/NATIVE_SUBAGENT_DISPATCH_PILOT_2026-09-02.md + docs/evidence/NATIVE_SUBAGENT_DISPATCH_STANDARDIZATION_2026-09-02.md
