...
| K13 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K14 | REVISOR | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K15 | FINAL GATE | `final_acceptance_gate` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `owner_acceptance` |

## ROUTE (`B10_ROUTE`)

| Key | Label | Prompt ID | Version | Owner | Insertion method | Next pass |
|---|---|---|---|---|---|---|
| K1 | RAW→ROUTE | `b10_route_raw_to_route` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K2 | THINGS? | `b10_route_things` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K3 | CALENDAR? | `b10_route_calendar` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K4 | NOTES? | `b10_route_notes` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K5 | AI OS? | `b10_route_ai_os` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K6 | THINKING? | `b10_route_thinking` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K7 | ANALYTICS? | `b10_route_analytics` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K8 | LLM? | `b10_route_llm` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K9 | CODEX? | `b10_route_codex` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K10 | CODEX APP? | `b10_route_codex_app` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K11 | BLOCKER | `blocker_review` | `1.1.0` | [Thinking] | `clipboard_paste` | `final_acceptance_gate` |
| K12 | HANDOFF | `handoff_prepare` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K13 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K14 | REVISOR | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
...
| Key | Label | Prompt ID | Version | Owner | Insertion method | Next pass |
|---|---|---|---|---|---|---|
| K1 | UNIVERSAL | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K2 | EVIDENCE | `judge_evidence` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K3 | ROUTE | `judge_route` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K4 | RISK | `judge_risk` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K5 | FRESHNESS | `judge_freshness` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K6 | ANALYTICS | `judge_analytics` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K7 | MEMO | `judge_memo` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K8 | PROMPT | `judge_prompt` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K9 | PR | `judge_pr` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K10 | LOCAL AI | `judge_local_ai` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K11 | BLOCKER | `blocker_review` | `1.1.0` | [Thinking] | `clipboard_paste` | `final_acceptance_gate` |
| K12 | HANDOFF | `handoff_prepare` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K13 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K14 | REVISOR | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
...
| Key | Label | Prompt ID | Version | Owner | Insertion method | Next pass |
|---|---|---|---|---|---|---|
| K1 | APPLY NOTES | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K2 | SHORTEN | `revisor_shorten` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K3 | CLEARER | `revisor_clearer` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K4 | EXEC VERSION | `revisor_exec_version` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K5 | FILE-READY | `revisor_file_ready` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K6 | MEMO | `revisor_memo` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K7 | DECISION | `revisor_decision` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K8 | STRUCTURE | `revisor_structure` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K9 | TONE | `revisor_tone` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K10 | SOURCE-PRESERVE | `revisor_source_preserve` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
| K11 | BLOCKER | `blocker_review` | `1.1.0` | [Thinking] | `clipboard_paste` | `final_acceptance_gate` |
| K12 | HANDOFF | `handoff_prepare` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K13 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K14 | REVISOR | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
...
| Key | Label | Prompt ID | Version | Owner | Insertion method | Next pass |
|---|---|---|---|---|---|---|
| K1 | FINANCE | `memo_finance` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K2 | MANAGEMENT | `memo_management` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K3 | EXEC SUMMARY | `memo_exec_summary` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K4 | FINDINGS | `memo_findings` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K5 | RISKS | `memo_risks` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K6 | RECOMMEND | `memo_recommend` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K7 | AUDIT FINDING | `memo_audit_finding` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K8 | CHART COMMENT | `memo_chart_comment` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K9 | APPENDIX | `memo_appendix` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K10 | FINAL MEMO | `memo_final_memo` | `1.0.0` | [LLM] / Memo | `clipboard_paste` | `final_acceptance_gate` |
| K11 | BLOCKER | `blocker_review` | `1.1.0` | [Thinking] | `clipboard_paste` | `final_acceptance_gate` |
| K12 | HANDOFF | `handoff_prepare` | `1.1.0` | [Inbox Router] | `clipboard_paste` | `final_acceptance_gate` |
| K13 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
| K14 | REVISOR | `revisor_apply_notes` | `1.0.0` | [LLM] / Revisor | `clipboard_paste` | `final_acceptance_gate` |
...
| K4 | JUDGE | `judge_universal` | `1.0.0` | [LLM] / Judge | `clipboard_paste` | `final_acceptance_gate` |
