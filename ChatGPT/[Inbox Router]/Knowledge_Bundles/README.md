# Knowledge Bundles — [Inbox Router]

## Purpose

This folder contains compact upload artifacts for ChatGPT Project Sources / Knowledge.

Granular files in `ChatGPT/[Inbox Router]/Knowledge/` and other listed source paths remain the source of truth. Do not delete or replace granular files with these bundles.

## Upload policy

- Paste `ChatGPT/[Inbox Router]/PROJECT_INSTRUCTIONS.md` into the ChatGPT Project Instructions field.
