# Knowledge Bundles — [Thinking]

## Purpose

This folder contains compact upload artifacts for ChatGPT Project Sources / Knowledge.

Granular files in `ChatGPT/[Thinking]/Knowledge/` and other listed source paths remain the source of truth. Do not delete or replace granular files with these bundles.
