...
Define the minimum task package needed for Codex App, Codex Web, Codex CLI, or IDE execution.

## Producer and executor

- Producer: `ChatGPT/[Codex]`
- Executor: `Codex App / Codex Web / Codex CLI / IDE`
...
## Smoke test for task package quality
