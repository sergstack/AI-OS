...
| `AIOS_02_GOVERNANCE_AND_EVIDENCE.md` | `GOVERNANCE_RULES.md`, `ANTI_PATTERNS.md`; repo-root `docs/standards/AUTONOMOUS_EXECUTION_STANDARD.md`, `docs/standards/AUTONOMOUS_EXECUTION_EXTENSION_CONTRACT.md`, `docs/standards/AUTONOMOUS_EXECUTION_CONTINUATION_CONTROL_PLANE_CONTRACT.md`, `docs/standards/LOCAL_FIRST_COMPUTE_POLICY.md`, `docs/standards/local_first_task_class_registry.json` |
...
| `AIOS_06_CROSS_PROJECT_AI_EVALS.md` | `AI_EVAL_REGISTRY.md`, `JUDGE_CALIBRATION.md`, `GOLDEN_EVAL_CASES.md`, `CROSS_PROJECT_EVAL_PLAYBOOK.md`, `ACT_OR_ABSTAIN_EVAL_GATE.md`, `GOAL_CONSISTENCY_CLOSURE_CHECK.md`, `FAILURE_REGISTRY.md`, `REGRESSION_GATE.md`, `INTERMEDIATE_STATE_ASSERTIONS.md` |
